            ...
            <a href="" class="dropdown-trigger texto btn-large waves-effect waves-light orange darken-3"
             data-target='dropdown1'>
                ...
                <ul id='dropdown1' class='texto dropdownonit dropdown-content'>
                    <li><a href="/biblioteca/puntuar?libroId=${libros.id}?puntuacion=10.0">(10) Obra Maestra</a></li>
                    <li><a href="/biblioteca/puntuar?libroId=${libros.id}?puntuacion=9.0">(9) Excelente</a></li>
                    <li><a href="/biblioteca/puntuar?libroId=${libros.id}?puntuacion=8.0">(8) Muy Bueno</a></li>
                    <li><a href="/biblioteca/puntuar?libroId=${libros.id}?puntuacion=7.0">(7) Bueno</a></li>
                    <li><a href="/biblioteca/puntuar?libroId=${libros.id}?puntuacion=6.0">(6) Ok</a></li>
                    <li><a href="/biblioteca/puntuar?libroId=${libros.id}?puntuacion=5.0">(5) Mediocre</a></li>
                    <li><a href="/biblioteca/puntuar?libroId=${libros.id}?puntuacion=4.0">(4) Malo</a></li>
                    <li><a href="/biblioteca/puntuar?libroId=${libros.id}?puntuacion=3.0">(3) Muy Malo</a></li>
                    <li><a href="/biblioteca/puntuar?libroId=${libros.id}?puntuacion=2.0">(2) Horrible</a></li>
                    <li><a href="/biblioteca/puntuar?libroId=${libros.id}?puntuacion=1.0">(1) Espantoso</a></li>
                </ul>
