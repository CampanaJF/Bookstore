...
insert into libro (lenguaje,publicado,sinopsis,titulo,autor_id,portada,esPremium,serie_id) values
                    ...
                    ('Ingles',substring(now(),1,11),'A Libro','A',1,'book',0,null),
					('Espanol',substring(now(),1,11),'B Libro','B',1,'book',0,null),
					('Italiano',substring(now(),1,11),'T Libro','T',2,'book',1,null),
					('Ingles',substring(now(),1,11),'C Libro','C',2,'book',1,null),
					('Espanol','2022-06-01','Quinto Libro','Cinco',2,'book',0,null);
